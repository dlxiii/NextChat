...
const en: LocaleType = {
  ...
  AuthCredential: {
    ...
    RegisterSubtitle: "Create an account to access your workspace.",
    ModeLogin: "Sign In",
    ...
    GoogleOAuthRedirecting: "Redirecting to Google...",
    GoogleOAuthSuccess: "Google sign-in successful.",
    GoogleOAuthFailed: "Google sign-in failed. Please try again.",
    GoogleOAuthCancelled: "Google authorization was cancelled.",
    GoogleOAuthStateMismatch:
      "Session validation expired. Please retry sign-in.",
    GoogleOAuthDisabled:
      "Google sign-in is currently disabled by the administrator.",
    BackupLink: "Use the legacy access-code page instead",
    Validation: "Please fill in email and password.",
    RegisterValidation: "Please fill in email, password, and confirmation.",
