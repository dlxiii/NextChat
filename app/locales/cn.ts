...
const cn = {
  ...
  AuthCredential: {
    ...
    GoogleOAuthRedirecting: "正在跳转到 Google...",
    GoogleOAuthSuccess: "Google 登录成功。",
    GoogleOAuthFailed: "Google 登录失败，请稍后重试。",
    GoogleOAuthCancelled: "你已取消 Google 授权。",
    GoogleOAuthStateMismatch: "登录会话已失效，请重新发起登录。",
    GoogleOAuthDisabled: "管理员暂未启用 Google 登录。",
    BackupLink: "使用旧版访问码页面",
    Validation: "请填写邮箱与密码。",
    RegisterValidation: "请填写邮箱、密码与确认密码。",
  ...
  Profile: {
    Title: "用户资料",
    SubTitle: "管理你的个人信息与偏好设置",
    DefaultName: "Hexagram 用户",
    SubtitleLoggedIn: "欢迎回来，完善资料以解锁更多服务",
    SubtitleLoggedOut: "登录后可同步至云端",
    EmailNotLoggedIn: "未登录",
    Username: {
      Title: "用户名",
      SubTitle: "2-16 位中文/字母/数字/下划线/空格",
      Placeholder: "请输入用户名",
      Error: "用户名需为 2-16 位中文/字母/数字/下划线/空格",
    },
    Avatar: "头像",
    AvatarLabel: "用户头像",
    Email: "注册邮箱",
    ...
    Save: {
      Title: "保存设置",
      Syncing: "正在同步至后端",
      SyncHint: "同步到后端并更新本地缓存",
      LocalHint: "未登录时仅保存到本地缓存",
      Button: "保存设置",
      SyncingButton: "同步中...",
    },
    Toasts: {
      LoadFailed: "读取后端资料失败，已使用本地缓存",
      Logout: "已注销登录",
      NameInvalid: "用户名需为 2-16 位中文/字母/数字/下划线/空格",
      AgeInvalid: "年龄需为 1-120 的数字",
